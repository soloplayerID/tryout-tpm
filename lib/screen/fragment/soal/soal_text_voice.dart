...
class SoalTextVoiceScreen extends StatefulWidget {
  ...
  const SoalTextVoiceScreen(
      {Key key, this.idtryoutdetail, this.idMatpel, this.matpel, this.jenjang})
      : super(key: key);
  @override
  _SoalTextVoiceScreenState createState() =>
      _SoalTextVoiceScreenState(idtryoutdetail, idMatpel, matpel);
}

class _SoalTextVoiceScreenState extends State<SoalTextVoiceScreen>
  ...
  _SoalTextVoiceScreenState(this.idtryoutdetail, this.idMatpel, this.matpel) {
