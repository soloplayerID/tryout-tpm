...
class SoalTimerFotoScreen extends StatefulWidget {
  final int idtryoutdetail;
  final int idMatpel;
  final String matpel;
  final int jenjang;

  const SoalTimerFotoScreen(
      {Key key, this.idtryoutdetail, this.idMatpel, this.matpel, this.jenjang})
      : super(key: key);
  @override
  _SoalTimerFotoScreenState createState() =>
      _SoalTimerFotoScreenState(idtryoutdetail, idMatpel, matpel);
}

class _SoalTimerFotoScreenState extends State<SoalTimerFotoScreen>
  ...
  _SoalTimerFotoScreenState(this.idtryoutdetail, this.idMatpel, this.matpel) {
