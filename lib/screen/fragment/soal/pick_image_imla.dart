...
class PickImageImla extends StatefulWidget {
  ...
  const PickImageImla(
      ...
      : super(key: key);
  @override
  _PickImageImlaState createState() => _PickImageImlaState();
}
...
class _PickImageImlaState extends State<PickImageImla> {
  ...
  Future _initJepret() async {
    ...
    if (pickedFile != null) {
      ...
      var request = http.MultipartRequest(
        'POST',
        Uri.parse("${Paths.BASEURL}${Paths.IMLA_UPDATEJAWABAN}"),
      );
