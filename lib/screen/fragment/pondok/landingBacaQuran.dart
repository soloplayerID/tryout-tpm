...
class LandingBacaQuran extends StatefulWidget {
  final int idPaket;
  final int idJenjang;
  final int idTryout;
  final int sekolahTujuan;

  const LandingBacaQuran(
      {Key key,
      this.idPaket,
      this.idJenjang,
      this.idTryout,
      ...
      : super(key: key);
  @override
  _LandingBacaQuranState createState() => _LandingBacaQuranState(
      this.idPaket, this.idJenjang, this.idTryout, this.sekolahTujuan);
}

class _LandingBacaQuranState extends State<LandingBacaQuran>
