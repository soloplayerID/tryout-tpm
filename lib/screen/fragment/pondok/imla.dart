...
class SoalImlaScreen extends StatefulWidget {
  ...
  const SoalImlaScreen(
      ...
      : super(key: key);
  @override
  _SoalImlaScreenState createState() =>
      _SoalImlaScreenState(idtryoutdetail, idMatpel, matpel);
}

class _SoalImlaScreenState extends State<SoalImlaScreen> implements SoalState {
  ...
  _SoalImlaScreenState(this.idtryoutdetail, this.idMatpel, this.matpel) {
  ...
  void initState() {
    ...
    this._soalPresenter.getSoalImla(idMatpel);
    records = [];
    pictures = [];
    videos = [];
